...
export const CanvasSize: { width: number; height: number } | 'auto' = { width: 300, height: 400 };
...
export const ResourcesPath = 'assets/live2d/g36_1904/';
export const ShaderPath = 'assets/live2d/shaders/';

export const BackImageName = '';
export const GearImageName = '';
export const PowerImageName = '';

export const ModelDir: string[] = ['normal'];
